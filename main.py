...
def generate_frames():
    while True:
        ...
        input_frame = (input_frame.astype(np.float32) - 127.5) / 127.5  # Normalize to [-1, 1]
...
@app.route('/')
def index():
    return render_template('index.html')  # You can create an HTML template for the MJPEG viewer
